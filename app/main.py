...
async def get_all_versions():
    res = requests.get(
        "https://raw.githubusercontent.com/Patrick564/go-versions-scrap/main/data/versions.json"
    )
...
async def get_selected_version(version: str):
    res = requests.get(
        "https://raw.githubusercontent.com/Patrick564/go-versions-scrap/main/data/selected_versions.json"
    )
